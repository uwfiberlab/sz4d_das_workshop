...
conda create --name workshop python=3.10 h5py scipy numpy pandas matplotlib pytorch-cpu gmt -y
conda activate workshop
pip install noisepy-seis ipykernel tqdm ELEP joblib seisbench pyocto pygmt
